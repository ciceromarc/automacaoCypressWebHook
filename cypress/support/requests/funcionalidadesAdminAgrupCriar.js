...
Cypress.Commands.add("CriarAgrupamentoAdmin", function () {
    ...
    var createGroup = `mutation createGroup($createGroupInput: CreateGroupInput!) {
...
Cypress.Commands.add("AlterarAgrupamentoAdmin", function (id, value) {
    ...
    var updateGroup = `mutation updateGroup($updateGroupInput: UpdateGroupInput!){
