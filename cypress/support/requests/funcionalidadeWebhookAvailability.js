Cypress.Commands.add("EnviaAvailability", function () {
    cy.request({
        method: "POST",
            url: Cypress.env("availability") + "availability",
        headers: {
